...
function JobSeekerManagement() {
  ...
  const [newJobSeeker, setNewJobSeeker] = useState({
    ...
    image: "",
    MaND: "",
    gioiTinh: 1, // Default to Male (1 = Male, 2 = Female)
    fileCV: "",
    thanhPho: "",
    diaChi: "",
    ngaySinh: "",
  ...
  const exportToPDF = () => {
    ...
    const headers = [
      ["Email", "Name", "Phone", "Gender", "City", "CV File", "Applications"],
    ];
        ...
        <tbody>
          {jobSeekers.map((jobSeeker) => (
            <tr key={jobSeeker.MaND} className="border-b">
              ...
              <td className="px-4 py-2">{jobSeeker.hoVaTen}</td>
              <td className="px-4 py-2">{jobSeeker.SDT}</td>
              <td className="px-4 py-2">
                {jobSeeker.gioiTinh === 1 ? "Nam" : "Nữ"}
              </td>
              <td className="px-4 py-2">{jobSeeker.thanhPho}</td>
