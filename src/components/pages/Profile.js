...
export default function Example() {
  ...
  return (
    ...
    <header className="bg-white">
        <nav aria-label="Global" className="mx-auto flex w-full items-center justify-start p-6 lg:px-8">
            <div className="flex lg:flex-1">
              <a href="#" className="-m-1.5 p-1.5">
                ...
                <img alt="" src="https://static.vecteezy.com/system/resources/thumbnails/020/272/341/small/it-alphabet-letters-curving-shape-initials-monogram-logo-it-t-and-i-pro-vector.jpg" className="h-8 w-auto" />
              </a>
            </div>
      ...
      <a href="#" className="text-2xl font-semibold leading-6 text-gray-900 flex items-center gap-x-2">
    ...
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Thông tin cá nhân</h2>
