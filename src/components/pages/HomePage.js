  ...
  return (
    <div>
      <header className="bg-white">
        <nav
          aria-label="Global"
          className="sticky top-0 z-50 mx-auto flex w-full items-center justify-between p-6 lg:px-8 bg-white shadow-lg"
        >
              ...
              <div className="-my-6 divide-y divide-gray-500/10">
                <div className="space-y-2 py-6">
                  {products.map((item) => (
                    <a
                      key={item.name}
                      className="block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50"
                    >
                      {item.name}
                    </a>
                  ))}
        ...
        <div className="w-full max-w-7xl mx-auto bg-white rounded-lg shadow-xl flex items-center space-x-4 p-4">
          ...
          <div className="flex items-center w-full">
            ...
            {/* <button
                ...
                className="inline-flex items-center px-4 h-12 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-r-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-blue-500"
              >
          ...
          <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
            {cc.map((product) => (
              <a key={product.id} className="group">
                ...
                <h3 className="mt-4 text-sm text-gray-700">{product.tieude}</h3>
